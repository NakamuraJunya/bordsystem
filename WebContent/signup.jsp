...
<form action="signup" method="post" onSubmit="return check()" style="color:white"><br />
	<label for="name" >名前:</label>
	<input maxlength='10' name="name" value="${user.name}" id="name"/>（10文字以内で入力してください）<br /><br />

	<label for="loginId">ログインID:</label>
	<input maxlength='20' name="loginId"value="${user.loginId}" id="loginId"/>（半角英数字6文字以上20文字以下で入力してください）<br /><br />
